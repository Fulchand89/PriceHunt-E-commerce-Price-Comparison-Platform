    ...
    <footer className="bg-slate-900 text-slate-300 pt-16 pb-12 border-t border-slate-800">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-10 mb-12">
          ...
          <div className="lg:col-span-2 space-y-4">
            ...
            <p className="text-sm text-slate-400 leading-relaxed pr-6">
              PriceHunt tracks live prices directly across Amazon India with
              real-time scraper precision to help you buy at the absolute best
              deal with verified price drops and instant alerts.
            </p>
          ...
          <div>
            ...
            <ul className="space-y-3 text-xs text-slate-400">
              <li className="flex items-start gap-2">
                ...
                <span>
                  Real-time price & delivery charge calculation
                </span>
              </li>
              ...
              <li className="flex items-start gap-2">
                <CheckCircle2 className="w-4 h-4 text-emerald-400 shrink-0 mt-0.5" />
                <span>
                  Historical price charts up to 1 year
                </span>
              </li>
        ...
        <div className="border-t border-slate-800 pt-8 flex flex-col md:flex-row items-center justify-between text-xs text-slate-500 gap-4">
          ...
          <p>
            &copy; {new Date().getFullYear()} PriceHunt – Smart E-Commerce
            Price Comparison Platform. All rights reserved.
          </p>
